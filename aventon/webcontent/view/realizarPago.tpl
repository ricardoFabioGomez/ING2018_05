      ...
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 my-4 mb-8 border">
			<form id="myForm" action="/aventon/pago/guardar" method="post">
			 <input type="hidden" id="fechaReal" name="fecha_nueva" value="{$fechaNueva}"> 
			<input type="hidden" id="idViaje" name="id_viaje_" value="{$idViaje}"> 
			<input type="hidden" id="tipoViaje" name="tipo_viaje" value="{$tipoViaje}"> 	
